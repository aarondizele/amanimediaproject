        ...
        <div class="row no-gutters home__container">
          <div class="col-12 col-lg-7 order-2 __header p-8 p-10-md pt-15-lg text-white">
            <div class="__header_content">
              ...
              <h5 class="aino-font">It's about inspiring &amp; empowering others</h5>
              <p
              ...
              <div class="">
                <button class="_button rounded-pill body-2 font-weight-medium px-5 py-2 _flex _center">
                  <a href="../assets/TBC bankerslivret.pdf" download>
...
export default {
  data: () => ({
    ...
    explorer: [
      ...
      { name: `Equipe`, url: "/equipe", image: require("../assets/team.jpg") }
    ]
  }),
  methods: {    
    onAutoCounter() {
...
.__card_explorer {
  ...
  border-radius: 2px;
  box-shadow: 4px 4px 0 rgba(249, 118, 82, .7);
